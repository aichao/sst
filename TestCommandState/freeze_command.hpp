...
#ifndef iTrek_freeze_command_hpp
#define iTrek_freeze_command_hpp
...
/**
 */
class freeze_command : public command_state {
 public:
  /** This method always transitions the state to freeze_file and returns
