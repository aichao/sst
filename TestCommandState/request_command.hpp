...
#ifndef iTrek_request_command_hpp
#define iTrek_request_command_hpp
...
/**
 */
class request_command : public command_state {
 public:
  /** This method always transitions the state to request_item and returns
